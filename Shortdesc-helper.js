...
window.sdh.initMessages = function () {
	...
	var enwikiMessages = {
		...
		'sdh-no-description': 'This page deliberately has no short description.',
		/* Initial view buttons */
		...
		/* Popup text */
		'sdh-no-description-popup': 'The description is deliberately empty because the page uses {{Short description|none}}.',
